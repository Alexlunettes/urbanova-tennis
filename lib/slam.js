...
export const SLAM_DRAW = [
  ...
  { seed:  9, name: 'David Gentil', external: true },
  { seed: 10, name: 'Jaime Benito Gutiérrez',    display: 'Jaime Benito' },
  { seed: 11, name: 'Manu del Oro' },
  { seed: 12, name: 'Javier Román' },
  { seed: 13, name: 'Valen Fraile' },
  { seed: 14, name: 'Carla Verdú' },
  { seed: 15, name: 'Martín Calvente Zamora',    display: 'Martín Calvente' },
  { seed: 16, name: 'Salvador Jaén Sánchez',     display: 'Salvador Jaén' },
]
