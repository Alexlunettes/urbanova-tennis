 ...
 *
 * The 3ª and the 4ª open the session at the same time on the two courts; the
 * 2ª and the 1ª follow one after another on Pista 1, with the 1ª closing the
 * tournament. The 1 Point Slam runs in the gap at 19:30 (see SLAM_SCHEDULE in
 * lib/slam.js).
 *
 * Note these are NOT in division order — playing order is 3ª, 4ª, 2ª, 1ª — so
 * anything listing them should sort by time rather than by level.
 */
export const FINAL_SCHEDULE = {
  3: { day: 'dom', time: '18:00', court: '1' },
  4: { day: 'dom', time: '18:00', court: '2' },
  2: { day: 'dom', time: '20:00', court: '1' },
  1: { day: 'dom', time: '21:30', court: '1' },
}
