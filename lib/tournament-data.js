...
export const TEAMS = [
  ...
  { id: 'c2-pascual-blanco',   level: 2, name: 'Pascual Blanco / Pascual Blanco',     players: ['Pascual Blanco', 'Pascual Blanco'] },
...
export const FIXTURES = [
  ...
  ['jue', '21:00', '1', 'c1-romero-valero',       'c1-garcia-soler'],
  ['jue', '21:45', '1', 'c1-rosales-skarmeta',    'c1-jaen-gil'],
  ['jue', '22:30', '1', 'c1-roman-jaen',          'c1-romero-valero'],
  ...
  ['vie', '23:15', '1', 'c4-conesa-benito',       'c4-espana-orts'],
  ...
  ['vie', '17:15', '2', 'c4-mateu-ibernon',       'c4-espana-orts'],
...
export const QUARTERFINAL_SCHEDULE = {
  ...
  4: {
    ...
    3: { day: 'sab', time: '17:00', court: '2' },      // 3º vs 6º
    4: { day: 'sab', time: '17:00', court: 'U5-6' },   // 4º vs 5º
  },
}
