 ...
 *
 * The winning squads keep their composition, so the final's four matches are
 * simply the two squads' pairs meeting division by division — team1 from the
 * first semifinal's winner, team2 from the second's.
 */
